    ...
    <div className='min-h-screen bg-[var(--color-card)] border-r border-[var(--color-primary-border)]'>
        {
        ...
        }
         {
            user === "Patient" && <ul className='text-white mt-5 '>
                ...
                <NavLink className={({isActive})=>`flex items-center gap-3 px-3 py-3.5 md:px-9 md:min-w-72 cursor-pointer ${isActive? 'bg-[var(--color-secondary)] border-0 rounded-full  border-r-4 border-primary': ''}`} to={'/appointment'}>
                    <img src={assetsAdmin.appointment_icon} alt="" />
